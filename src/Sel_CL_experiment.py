...
def parse_args(command=None):
    ...
    parser.add_argument('--epoch', type=int, default=30, help='training epoches')
    ...
    parser.add_argument('--lr', '--base-learning-rate', '--base-lr', type=float, default=1e-4, help='learning rate')
...
if __name__ == '__main__':
    ...
    for dataset_name in ucr:
        ...
        # Construct the full path with the label noise type
        path = os.path.abspath(os.path.join(basicpath, 'statistic_results', f'{args.outfile}_{noise_type}.csv'))
