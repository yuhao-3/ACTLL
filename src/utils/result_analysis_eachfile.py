...
for file_name in csv_files:
    ...
    try:
        ...
        # Exclude rows where 'dataset_name' is 'eICU'
        if 'dataset_name' in df.columns:
            df = df[df['dataset_name'] != 'eICU']
        ...
        if 'avg_five_test_f1' in df.columns and 'std_five_test_f1' in df.columns:
            # Calculate the mean of avg_five_test_f1 and std_five_test_f1 after excluding eICU rows
