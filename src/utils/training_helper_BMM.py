...
def train_model(model, train_loader, valid_loader, test_loader, mixup, bootbeta, args, saver=None):
    ...
    #     os.path.join(args.basicpath, 'acc_f1_list', args.model, os.pathsep))
    # acc_npy_path = os.path.abspath(
    #     os.path.join(args.basicpath, 'acc_f1_list', args.model, "{}_acc.npy".format(args.dataset)))
    # f1_npy_path = os.path.abspath(
    #     os.path.join(args.basicpath, 'acc_f1_list', args.model, "{}_f1.npy".format(args.dataset)))
